...
const EmptyContent = () => {
  return (
        <div className='mx-auto '>
            ...
            <Link
                className="mx-auto flex justify-center w-[150px] items-center gap-2 rounded bg-primary py-2 text-lg font-medium text-white transition focus:outline-none focus:ring active:bg-primary"
                href="/"
            >
                <IoIosHome />
                Home
